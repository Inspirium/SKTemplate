<template>
    <div class="modal fade" id="taskOrderApprovalModal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header flex-column px-3 pt-3">
                    ...
                    <div class="d-flex mx-auto">
                        ...
                        <h1 class="modal-title w-100 text-center">{{ lang('Task Order Approve') }}</h1>
                    </div>
