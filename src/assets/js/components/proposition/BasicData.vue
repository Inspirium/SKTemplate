<template>
    <div class="row">
        <div class="col-md-12">
            ...
            <!-- Input field -->
            <div class="md-form">
                <input type="text" id="title" class="form-control" name="title" v-bind:placeholder="lang('Title')" required v-model.lazy.trim="proposition.title">
            ...
            <div class="chip mb-3" v-for="(author, index) in proposition.authors" v-on:chip.delete="author_delete">
                <img v-bind:src="author.image"> {{ author.name }}<i class="close fa fa-times"></i>
            </div>

            <!-- Textarea -->
            <div class="md-form mt-2">
                <textarea id="concept" name="concept" class="md-textarea" v-model.lazy.trim="proposition.concept"></textarea>
            ...
            <div class="form-inline">
                <fieldset class="form-group">
                    <input name="manuscript" type="radio" id="ordered" value="ordered" v-model="proposition.manuscript">
                    <label for="ordered">{{ lang('Ordered') }}</label>
                </fieldset>
                <fieldset class="form-group">
                    <input name="manuscript" type="radio" id="delivered" value="delivered" v-model="proposition.manuscript">
                    <label for="delivered">{{ lang('Delivered') }}</label>
                </fieldset>
            </div>
            <template v-if="proposition.manuscript === 'delivered'">
                ...
                <div class="files mt-2 mb-2">
                    <div class="file-box file-box-l d-flex align-items-center" v-for="(document,index) in proposition.manuscript_documents">
            ...
            <div class="form-inline mb-2">
                <fieldset class="form-group">
                    <input name="dotation" type="radio" id="dot-yes" value="yes" v-model="proposition.dotation">
                    <label for="dot-yes">{{ lang('Yes') }}</label>
                </fieldset>
                <fieldset class="form-group">
                    <input name="dotation" type="radio" id="dot-no" value="no" v-model="proposition.dotation">
                    <label for="dot-no">{{ lang('No') }}</label>
                </fieldset>
            </div>
            <template v-if="proposition.dotation === 'yes'">
                <!-- Show only if "Yes"  -->
                <!-- Input field -->
                <div class="row">
                    <div class="col-md-6">
                        <div class="md-form">
                            <input type="text" id="dot-origin" class="form-control" name="dotation-origin" v-model.lazy.trim="proposition.dotation_origin">
                            <label for="dot-origin" class="">{{ lang('Dotation Origin') }}</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="md-form">
                            <input type="text" id="dot-ammount" class="form-control" name="dotation-ammount" v-model.lazy.trim="proposition.dotation_ammount">
            ...
            <div class="md-form mt-1">
                <textarea id="note" name="note" v-model.lazy.trim="proposition.basic_data_note" class="md-textarea"></textarea>
            ...
            <div class="form-inline">
                <fieldset class="form-group">
                    <input name="products" type="checkbox" id="products-ebook" value="ebook" v-model="proposition.possible_products">
                    <label for="products-ebook">{{ lang('E-book') }}</label>
                </fieldset>
                <fieldset class="form-group">
                    <input name="products" type="checkbox" id="products-website" value="website" v-model="proposition.possible_products">
                    <label for="products-website">{{ lang('Website') }}</label>
                </fieldset>
                <fieldset class="form-group">
                    <input name="products" type="checkbox" id="products-app" value="app" v-model="proposition.possible_products">
                    <label for="products-app">{{ lang('App') }}</label>
                </fieldset>
                <fieldset class="form-group">
                    <input name="products" type="checkbox" id="products-lang" value="language" v-model="proposition.possible_products">
                    <label for="products-lang">{{ lang('Additional Language') }}</label>
                </fieldset>
                <fieldset class="form-group">
                    <input name="products" type="checkbox" id="products-short" value="short" v-model="proposition.possible_products">
...
<script>
    ...
    export default {
        ...
        computed: mapState('proposition',{
            proposition: (state) => state.proposition
        })
    }
</script>
