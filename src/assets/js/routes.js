...
export const routes = [
    ...
    { path: '/proposition/:id', component: Proposition, name: 'proposition',
        children: [
            ...
            { path: 'preparation/translation', component: UploadDocument, meta: {save: 'files', dir: 'translation', validate: {id:'int'}, breadcrumb: 'Translation'} },
            { path: 'preparation/technical_preparation', component: UploadDocument, meta: {save: 'files', dir: 'technical_preparation', validate: {id:'int'}, breadcrumb: 'Technical Preparation'} },
            { path: 'preparation/proofreading', component: UploadDocument, meta: {save: 'files', dir: 'proofreading', validate: {id:'int'}, breadcrumb: 'Proofreading'} },
            { path: 'preparation/additional_materials', component: UploadDocument, meta: {save: 'files', dir: 'additional_materials', validate: {id:'int'}, breadcrumb: 'Additional Materials'} },
            { path: 'preparation/reviews', component: UploadDocument, meta: {save: 'files', dir: 'reviews', validate: {id:'int'}, breadcrumb: 'Reviews'} },
            { path: 'preparation/lecture', component: UploadDocument, meta: {save: 'files', dir: 'lecture', validate: {id:'int'}, breadcrumb: 'Lecture'} },
            { path: 'preparation/technical_correction', component: UploadDocument, meta: {save: 'files', dir: 'technical_correction', validate: {id:'int'}, breadcrumb: 'Technical Correction'} },
            { path: 'preparation/final_review', component: UploadDocument, meta: {save: 'files', dir: 'final_review', validate: {id:'int'}, breadcrumb: 'Final Review'} },
            ...
            { path: 'design/cover_design', component: UploadDocument, meta: {save: 'files', dir: 'cover_design',validate: {id:'int'}, breadcrumb: 'Cover Design'} },
            { path: 'design/layout_design', component: UploadDocument, meta: {save: 'files', dir: 'layout_design',validate: {id:'int'}, breadcrumb: 'Layout Design'} },

            { path: 'layout/first_block_layout', component: UploadDocument, meta: {save: 'files', dir: 'first_block_layout',validate: {id:'int'}, breadcrumb: 'First Block Layout'} },
            { path: 'layout/cover', component: UploadDocument, meta: {save: 'files', dir: 'cover',validate: {id:'int'}, breadcrumb: 'Cover'} },
            { path: 'layout/layout', component: UploadDocument, meta: {save: 'files', dir: 'layout',validate: {id:'int'}, breadcrumb: 'Layout'} },
            { path: 'layout/first_revision', component: UploadDocument, meta: {save: 'files', dir: 'first_revision',validate: {id:'int'}, breadcrumb: 'First Revision'} },
            { path: 'layout/correction', component: UploadDocument, meta: {save: 'files', dir: 'correction',validate: {id:'int'}, breadcrumb: 'Correction'} },
            { path: 'layout/correction_input', component: UploadDocument, meta: {save: 'files', dir: 'correction_input',validate: {id:'int'}, breadcrumb: 'Correction Input'} },
            ...
            { path: 'prepress/print_proof', component: UploadDocument, meta: {save: 'files', dir: 'print_proof',validate: {id:'int'}, breadcrumb: 'Print Proof'} },
            { path: 'prepress/print_proof_correction', component: UploadDocument, meta: {save: 'files', dir: 'print_proof_correction',validate: {id:'int'}, breadcrumb: 'Print Proof Correction'} },
            { path: 'prepress/print', component: UploadDocument, meta: {save: 'files', dir: 'print',validate: {id:'int'}, breadcrumb: 'Print'} },
