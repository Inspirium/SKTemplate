...
<div class="content">       
    <div class="profile_head pb-2 row">
       <div class="col-md-3">
            <h6 class="white_label">@lang('Budget')</h6>
            <h3 class="mb-1 text-white">123.450 kn</h3>  
       </div>
       <div class="col-md-3">
            <h6 class="white_label">@lang('Expenses')</h6>
            <h3 class="mb-1 text-white">155.446 kn</h3>  
       </div>
       <div class="col-md-3">
            <h6 class="white_label">@lang('Difference')</h6>
            <h3 class="mb-1 text-white">22.985 kn</h3>  
       </div>
       <div class="col-md-3">
            <h6 class="white_label">@lang('Difference in precentage')</h6>
