...
@section('content')
    ...
    <div class="content"> 
        ...
        <a href="#" class="hoverable d-block">
            <div class="row text-white btn_sub2 d-flex py-4">
                <div class="col-md-3">
                    <h6 class="no_border display-b text-white">@lang('Circulation')</h6>
                    <h1 class="mb-1 text-white weight-700">4500 komada</h1>    
                </div>
                <div class="col-md-3">
                    <h6 class="no_border display-b text-white">@lang('Total Cost')</h6>
                    <h1 class="mb-1 text-white">215.000 kn</h1>    
                </div>
                <div class="col-md-2">
                    <div class=" page-name-l-white border_white">@lang('Direct Cost Cover')</div>
                    <div>
