...
<div class="profile_head pt-3 pb-2 d-flex flex-column justify-content-center align-items-center">
    <h6 class="text-center no_border display-e text-white">@lang('Total Cost')</h6>
    <h1 class="text-center display-2 mb-2 text-white">215.000 kn</h1>    
</div>
    <div class="content profile_head">       
    <div class="row text-white d-flex justify-content-center text-center">
        <div class="col-md-4">
            <div class="page-name-l-white text-center border_white">@lang('Direct Cost Cover')</div>
            <div>
                <h6 class="no_border text-white">@lang('Number of Sold Copies')</h6>
